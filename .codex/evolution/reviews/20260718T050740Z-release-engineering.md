...
- The first real `makensis` run rejected top-level `SetShellVarContext`; a regression check now enforces section placement, and both install and uninstall sections select the current-user shell context before shortcut operations.
