...
This manifest lists every non-ignored source file except itself. Build outputs under `target/` and `dist/`, runtime config/data, CBM indexes, `.opencode/`, and task state are intentionally excluded.
...
| `.codex/evolution/reviews/20260718T050740Z-release-engineering.md` | 3432 | `14f284c9fe7c65a91d7d9adf39213aaf474105fc79dd369e86f0d75e800d2d15` |
...
| `API_PROVIDERS.md` | 1457 | `c795374ac37cbb514a5f0064188444e9cf9efc402dfc279d2f0e78ef4d645b8b` |
| `ARCHITECTURE.md` | 2810 | `b74d1524bf0861611786aeaeb18993d1766a7dd3a57d43057f0dab26029eae88` |
| `build.rs` | 396 | `d1ab98ae1ae5689738702062de595e38d366d4dc5ca2d6bd7d586db34d130a54` |
...
| `installer/SpeakTypeCloud.nsi` | 2809 | `34337c71674666d8f71594e2dc874b1ddca53e45a41a748d26e96e7d167dfea6` |
...
| `scripts/check.ps1` | 691 | `221b56fb48994c170eb37df210a06a4896fad44bdcb1ed553de5e705730a6c31` |
| `scripts/generate-sbom.ps1` | 4401 | `c761bf1fea37b84174b9f5b27289cd019e725446fd8a16666ad4b5718a520bfb` |
| `scripts/install-nsis-build-tool.ps1` | 2480 | `287be5ba0240b686d7adb971615b563494141eaa53f048342bb761159e5ba2b6` |
| `scripts/new-app-icon.ps1` | 2791 | `edd6ed25b03fa089c14961dbf88ccfa9b25d6616705406e51dbc63e1cfe7e415` |
| `scripts/new-update-manifest.ps1` | 1859 | `2e6af6757fd6db61a430a8a122d5a42444714a528ab8283f1f3b724473d2594d` |
...
| `scripts/test-release.ps1` | 4993 | `9d99c1424f32278dfefb8a1f2eecfc06492b7131ebeebbaea58318945b37a507` |
...
| `src/app.rs` | 50458 | `ca76acfbd068f7d40fe0d3082323d25529518d313aabb71bd3f29f9cea37f036` |
| `src/audio.rs` | 19209 | `1bfd1e29e62aa701a69d08910692510cbe178e936cda208ac50903afeb5d3c24` |
| `src/config.rs` | 17489 | `4b4e8d94885fea037b8ee1c08a06dbeaa3e61a9dcf304f3128bddbe266e80b8a` |
| `src/error.rs` | 953 | `1b9d90ee72bfec59d34f7deb928fc54b51c40ca9c2b4b10f59faee0fb512c4cf` |
| `src/fonts.rs` | 2865 | `750c7e2c73bd984092f900b4062f3a1e5abab495846d8a3be4358b5a8273172b` |
| `src/history.rs` | 1963 | `a9dde0f121cc948d40b2dc534dc8bbca2cb13704c4af0ff2e82f93bfd1547e0b` |
| `src/hotkey.rs` | 10077 | `e49baae472317c8016597e2b8b127f5159fa43b96e155aede1c62df26e6d7f01` |
| `src/injector.rs` | 4914 | `4bd428ad3c6f3a617f74b429e0ca09b1362d989532e282e3a29bc8dd96378c07` |
| `src/main.rs` | 967 | `77831ad722131b9984fa253c1c4da037ecd308e39e0e3f3ecba528766da1058a` |
| `src/paths.rs` | 641 | `efaee684f92e80226d92ba6af168505e66f33562fb36c4fc7f7cdf7ad22afc10` |
| `src/postprocess.rs` | 11522 | `95da77e635a1c34f84e942c8dce07a45d1ae2260fb2fb322f71a68135dc62e7d` |
| `src/providers/mod.rs` | 6369 | `bbf9ccfe44c471ece81d21e12ef9b730724b78b8042b7299100aad4d7cf865a1` |
| `src/providers/openai.rs` | 8235 | `c878e102be548d56c292b01f331f6c93c2cb8c9c17b3fba5e978d84e5377225d` |
| `src/providers/xai.rs` | 8515 | `bc2a740f2951df96735a92190a56c006ba64c033e07600a9c296728c4cf2a2a3` |
| `src/realtime_worker.rs` | 16058 | `af92ab0c6fa284268937d488b3ffe13b79f0d29e405b7157284df82466506db5` |
| `src/realtime/mod.rs` | 5175 | `350e097f68b623cb08e469ec8544dbfb089f4622bbf3a0a6f38d22189412347e` |
| `src/realtime/openai.rs` | 20233 | `1a6a96802ecd1caedfa2aedaa0e1f59d679f453ed0373ecc3767e0ad84c7497b` |
| `src/realtime/xai.rs` | 15065 | `60ab08dd81f0afc2facd3665c942c74d39f45de3a764fde20620f7c3d1bdd592` |
